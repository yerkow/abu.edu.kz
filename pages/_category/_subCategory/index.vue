<template>
  <div class="wrapper__content wrapper__content_page wrapper__content_aside">
    ...
    <div class="wrapper__main">
      <h1 class="wrapper__title title-1">
        {{ currentPage['title' + $t('currentLangUpper')] }}
      </h1>
      <ContentComponent
        :current-page="currentPage"
        :current-page-contents="currentPageContents"
      />

      <FacultiesComponent
        v-if="currentPage.contentType==4"
        :current-page="currentPage"
      ...
      <div class="content-share">
        <div class="content-share__name title-6">
          {{ $t('post.share') }}:
        </div>
...
export default {
  ...
  async asyncData({store, error, params}) {
    const pageSlug = params.subCategory;
    ...
    try {
      ...
      return {pageID, currentPage, parentPage, childPages, asideList, currentPageContents, parents};
