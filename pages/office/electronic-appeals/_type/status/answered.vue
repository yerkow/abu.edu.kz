<template>
  <div>
    <el-breadcrumb separator="/" class="mb2">
      ...
      <el-breadcrumb-item>Отвеченные</el-breadcrumb-item>
    </el-breadcrumb>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button @click="handleClick" type="text" size="small">Подробнее</el-button>
...
export default {
  ...
  async asyncData({store,params}) {
    ...
    const items = await store.dispatch('electronic_appeals/getListByType',{type,status:1})
  ...
  methods: {
    changeStatus(){
      if(this.status === 'new'){
        this.$router.push(`/office/electronic-appeals/${this.type}/status/new`)
      }
    },
    handleClick(){
